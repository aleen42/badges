...
- [![grok](./src/grok.svg)](https://badges.aleen42.com/src/grok.svg) A badge used for projects utilizing [Grok](https://github.com/xai-org/grok-1)
- [![openai](./src/openai.svg)](https://badges.aleen42.com/src/openai.svg) A badge used for projects utilizing [OpenAI](https://github.com/openai) models
- [![pytorch](./src/pytorch.svg)](https://badges.aleen42.com/src/pytorch.svg) A badge used for projects built with [PyTorch](https://github.com/pytorch/pytorch)
- [![anthropic](./src/anthropic.svg)](https://badges.aleen42.com/src/anthropic.svg) A badge used for projects utilizing [Anthropic](https://github.com/anthropics) models
- [![hugging_face](./src/hugging_face.svg)](https://badges.aleen42.com/src/hugging_face.svg) A badge used for projects utilizing [Hugging Face](https://github.com/huggingface)
- [![langchain](./src/langchain.svg)](https://badges.aleen42.com/src/langchain.svg) A badge used for projects built with [LangChain](https://github.com/langchain-ai/langchain)
- [![langgraph](./src/langgraph.svg)](https://badges.aleen42.com/src/langgraph.svg) A badge used for projects built with [LangGraph](https://github.com/langchain-ai/langgraph)
- [![chatglm](./src/chatglm.svg)](https://badges.aleen42.com/src/chatglm.svg) A badge used for projects utilizing GLM models provided by [z.ai](https://github.com/zai-org)
- [![qwen](./src/qwen.svg)](https://badges.aleen42.com/src/qwen.svg) A badge used for projects utilizing [Qwen](https://github.com/QwenLM/Qwen)
- [![deepseek](./src/deepseek.svg)](https://badges.aleen42.com/src/deepseek.svg) A badge used for projects utilizing [DeepSeek](https://github.com/deepseek-ai/DeepSeek-V3)
- [![google_gemini](./src/google_gemini.svg)](https://badges.aleen42.com/src/google_gemini.svg) A badge used for projects utilizing [Google Gemini](https://github.com/google-gemini)


### Coder

- [![nextdotjs](./src/nextdotjs.svg)](https://badges.aleen42.com/src/nextdotjs.svg) A badge used for projects built with [Next.js](https://github.com/vercel/next.js)
...
- [![gulp](./src/gulp.svg)](https://badges.aleen42.com/src/gulp.svg) A badge used for projects using [Gulp](https://github.com/gulpjs/gulp) to build
- [![angular](./src/angular.svg)](https://badges.aleen42.com/src/angular.svg) A badge used for repositories which has used the framework, [Angular](https://github.com/angular/angular)
- [![redis](./src/redis.svg)](https://badges.aleen42.com/src/redis.svg) A badge used for projects using [Redis](https://github.com/redis/redis)
...
- [![rust](./src/rust.svg)](https://badges.aleen42.com/src/rust.svg) A badge used for projects that coded with [Rust](https://github.com/rust-lang/rust)
...
- [![svelte](./src/svelte.svg)](https://badges.aleen42.com/src/svelte.svg) A badge used for projects built with [Svelte](https://github.com/sveltejs/svelte)
...
- [![mocha](./src/mocha.svg)](https://badges.aleen42.com/src/mocha.svg) A badge used for projects using [Mocha](https://github.com/mochajs/mocha) for unit tests
- [![bower](./src/bower.svg)](https://badges.aleen42.com/src/bower.svg) A badge used for [bower](https://github.com/bower/bower) packages
...
- [![java](./src/java.svg)](https://badges.aleen42.com/src/java.svg) A badge used for projects that coded with [Java](https://github.com/openjdk/jdk)
...
- [![grunt](./src/grunt.svg)](https://badges.aleen42.com/src/grunt.svg) A badge used for projects using [grunt](https://github.com/gruntjs/grunt) to build
- [![tensorflow](./src/tensorflow.svg)](https://badges.aleen42.com/src/tensorflow.svg) A badge use for projects using [Tensorflow](https://github.com/tensorflow/tensorflow)
...
- [![node](./src/node.svg)](https://badges.aleen42.com/src/node.svg) A badge used for projects built with [Node.js](https://github.com/nodejs/node)
- [![mongodb](./src/mongodb.svg)](https://badges.aleen42.com/src/mongodb.svg) A badge used for projects using [MongoDB](https://github.com/mongodb/mongo)
...
- [![vue](./src/vue.svg)](https://badges.aleen42.com/src/vue.svg) A badge used for repositories which has used the framework, [Vue](https://github.com/vuejs/core)
- [![vuepress](./src/vuepress.svg)](https://badges.aleen42.com/src/vuepress.svg) A badge used for books publish by [Vuepress](https://github.com/vuejs/vuepress)
- [![supabase](./src/supabase.svg)](https://badges.aleen42.com/src/supabase.svg) A badge used for projects using [Supabase](https://github.com/supabase/supabase)
- [![apiary](./src/apiary.svg)](https://badges.aleen42.com/src/apiary.svg) A badge used for documents written on Apiary
- [![fastapi](./src/fastapi.svg)](https://badges.aleen42.com/src/fastapi.svg) A badge used for projects built with [FastAPI](https://github.com/fastapi/fastapi)
...
- [![golang](./src/golang.svg)](https://badges.aleen42.com/src/golang.svg) A badge used for projects that coded with [Golang](https://github.com/golang/go)
...
- [![kotlin](./src/kotlin.svg)](https://badges.aleen42.com/src/kotlin.svg) A badge used for projects that coded with [Kotlin](https://github.com/JetBrains/kotlin)
- [![visual_studio_code](./src/visual_studio_code.svg)](https://badges.aleen42.com/src/visual_studio_code.svg) A badge for the [Visual Studio Code](https://github.com/microsoft/vscode) IDE
...
- [![typescript](./src/typescript.svg)](https://badges.aleen42.com/src/typescript.svg) A badge used for projects that coded with [TypeScript](https://github.com/microsoft/TypeScript)
- [![cplusplus](./src/cplusplus.svg)](https://badges.aleen42.com/src/cplusplus.svg) A badge used for projects that coded with C++
- [![flutter](./src/flutter.svg)](https://badges.aleen42.com/src/flutter.svg) A badge used for projects built with [Flutter](https://github.com/flutter/flutter)
- [![python](./src/python.svg)](https://badges.aleen42.com/src/python.svg) A badge used for projects that coded with [Python](https://github.com/python/cpython)
...
- [![marko](./src/marko.svg)](https://badges.aleen42.com/src/marko.svg) A badge used for projects which has used [marko](https://github.com/marko-js/marko) for templating
...
- [![kubernetes](./src/kubernetes.svg)](https://badges.aleen42.com/src/kubernetes.svg) A badge used for projects using [Kubernetes](https://github.com/kubernetes/kubernetes)
- [![postgresql](./src/postgresql.svg)](https://badges.aleen42.com/src/postgresql.svg) A badge used for projects using [PostgreSQL](https://github.com/postgres/postgres)
...
- [![eslint](./src/eslint.svg)](https://badges.aleen42.com/src/eslint.svg) A badge used for projects using [ESLint](https://github.com/eslint/eslint)
...
- [![redux](./src/redux.svg)](https://badges.aleen42.com/src/redux.svg) A badge used for projects using [React Redux](https://github.com/reduxjs/react-redux)
...
- [![csharp](./src/csharp.svg)](https://badges.aleen42.com/src/csharp.svg) A badge used for projects that coded with C#
- [![jasmine](./src/jasmine.svg)](https://badges.aleen42.com/src/jasmine.svg) A badge used for projects using [Jasmine](https://github.com/jasmine/jasmine) for testing JavaScript
- [![qunit](./src/qunit.svg)](https://badges.aleen42.com/src/qunit.svg) A badge for projects using [QUnit](https://github.com/qunitjs/qunit) for unit tests
- [![reactivex](./src/reactivex.svg)](https://badges.aleen42.com/src/reactivex.svg) A badge for projects using [ReactiveX](https://github.com/ReactiveX/RxJS)
- [![modernizr](./src/modernizr.svg)](https://badges.aleen42.com/src/modernizr.svg) A badge for projects using [Modernizr](https://github.com/Modernizr/Modernizr)
...
- [![erlang](./src/erlang.svg)](https://badges.aleen42.com/src/erlang.svg) A badge used for projects that coded with [Erlang](https://github.com/erlang/otp)
- [![nestjs](./src/nestjs.svg)](https://badges.aleen42.com/src/nestjs.svg) A badge used for projects built with [NestJS](https://github.com/nestjs/nest)
...
- [![npm](./src/npm.svg)](https://badges.aleen42.com/src/npm.svg) A badge used for [npm](https://github.com/npm/cli) packages
