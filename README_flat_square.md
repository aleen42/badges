...
- [![grok](./src/grok_flat_square.svg)](https://badges.aleen42.com/src/grok_flat_square.svg) A badge used for projects utilizing [Grok](https://github.com/xai-org/grok-1)
- [![openai](./src/openai_flat_square.svg)](https://badges.aleen42.com/src/openai_flat_square.svg) A badge used for projects utilizing [OpenAI](https://github.com/openai) models
- [![pytorch](./src/pytorch_flat_square.svg)](https://badges.aleen42.com/src/pytorch_flat_square.svg) A badge used for projects built with [PyTorch](https://github.com/pytorch/pytorch)
- [![anthropic](./src/anthropic_flat_square.svg)](https://badges.aleen42.com/src/anthropic_flat_square.svg) A badge used for projects utilizing [Anthropic](https://github.com/anthropics) models
- [![hugging_face](./src/hugging_face_flat_square.svg)](https://badges.aleen42.com/src/hugging_face_flat_square.svg) A badge used for projects utilizing [Hugging Face](https://github.com/huggingface)
- [![langchain](./src/langchain_flat_square.svg)](https://badges.aleen42.com/src/langchain_flat_square.svg) A badge used for projects built with [LangChain](https://github.com/langchain-ai/langchain)
- [![langgraph](./src/langgraph_flat_square.svg)](https://badges.aleen42.com/src/langgraph_flat_square.svg) A badge used for projects built with [LangGraph](https://github.com/langchain-ai/langgraph)
- [![chatglm](./src/chatglm_flat_square.svg)](https://badges.aleen42.com/src/chatglm_flat_square.svg) A badge used for projects utilizing GLM models provided by [z.ai](https://github.com/zai-org)
- [![qwen](./src/qwen_flat_square.svg)](https://badges.aleen42.com/src/qwen_flat_square.svg) A badge used for projects utilizing [Qwen](https://github.com/QwenLM/Qwen)
- [![deepseek](./src/deepseek_flat_square.svg)](https://badges.aleen42.com/src/deepseek_flat_square.svg) A badge used for projects utilizing [DeepSeek](https://github.com/deepseek-ai/DeepSeek-V3)
- [![google_gemini](./src/google_gemini_flat_square.svg)](https://badges.aleen42.com/src/google_gemini_flat_square.svg) A badge used for projects utilizing [Google Gemini](https://github.com/google-gemini)


### Coder

- [![nextdotjs](./src/nextdotjs_flat_square.svg)](https://badges.aleen42.com/src/nextdotjs_flat_square.svg) A badge used for projects built with [Next.js](https://github.com/vercel/next.js)
...
- [![gulp](./src/gulp_flat_square.svg)](https://badges.aleen42.com/src/gulp_flat_square.svg) A badge used for projects using [Gulp](https://github.com/gulpjs/gulp) to build
- [![angular](./src/angular_flat_square.svg)](https://badges.aleen42.com/src/angular_flat_square.svg) A badge used for repositories which has used the framework, [Angular](https://github.com/angular/angular)
- [![redis](./src/redis_flat_square.svg)](https://badges.aleen42.com/src/redis_flat_square.svg) A badge used for projects using [Redis](https://github.com/redis/redis)
...
- [![rust](./src/rust_flat_square.svg)](https://badges.aleen42.com/src/rust_flat_square.svg) A badge used for projects that coded with [Rust](https://github.com/rust-lang/rust)
...
- [![svelte](./src/svelte_flat_square.svg)](https://badges.aleen42.com/src/svelte_flat_square.svg) A badge used for projects built with [Svelte](https://github.com/sveltejs/svelte)
...
- [![mocha](./src/mocha_flat_square.svg)](https://badges.aleen42.com/src/mocha_flat_square.svg) A badge used for projects using [Mocha](https://github.com/mochajs/mocha) for unit tests
- [![bower](./src/bower_flat_square.svg)](https://badges.aleen42.com/src/bower_flat_square.svg) A badge used for [bower](https://github.com/bower/bower) packages
...
- [![java](./src/java_flat_square.svg)](https://badges.aleen42.com/src/java_flat_square.svg) A badge used for projects that coded with [Java](https://github.com/openjdk/jdk)
...
- [![grunt](./src/grunt_flat_square.svg)](https://badges.aleen42.com/src/grunt_flat_square.svg) A badge used for projects using [grunt](https://github.com/gruntjs/grunt) to build
- [![tensorflow](./src/tensorflow_flat_square.svg)](https://badges.aleen42.com/src/tensorflow_flat_square.svg) A badge use for projects using [Tensorflow](https://github.com/tensorflow/tensorflow)
...
- [![node](./src/node_flat_square.svg)](https://badges.aleen42.com/src/node_flat_square.svg) A badge used for projects built with [Node.js](https://github.com/nodejs/node)
- [![mongodb](./src/mongodb_flat_square.svg)](https://badges.aleen42.com/src/mongodb_flat_square.svg) A badge used for projects using [MongoDB](https://github.com/mongodb/mongo)
...
- [![vue](./src/vue_flat_square.svg)](https://badges.aleen42.com/src/vue_flat_square.svg) A badge used for repositories which has used the framework, [Vue](https://github.com/vuejs/core)
- [![vuepress](./src/vuepress_flat_square.svg)](https://badges.aleen42.com/src/vuepress_flat_square.svg) A badge used for books publish by [Vuepress](https://github.com/vuejs/vuepress)
- [![supabase](./src/supabase_flat_square.svg)](https://badges.aleen42.com/src/supabase_flat_square.svg) A badge used for projects using [Supabase](https://github.com/supabase/supabase)
...
- [![fastapi](./src/fastapi_flat_square.svg)](https://badges.aleen42.com/src/fastapi_flat_square.svg) A badge used for projects built with [FastAPI](https://github.com/fastapi/fastapi)
...
- [![golang](./src/golang_flat_square.svg)](https://badges.aleen42.com/src/golang_flat_square.svg) A badge used for projects that coded with [Golang](https://github.com/golang/go)
...
- [![kotlin](./src/kotlin_flat_square.svg)](https://badges.aleen42.com/src/kotlin_flat_square.svg) A badge used for projects that coded with [Kotlin](https://github.com/JetBrains/kotlin)
- [![visual_studio_code](./src/visual_studio_code_flat_square.svg)](https://badges.aleen42.com/src/visual_studio_code_flat_square.svg) A badge for the [Visual Studio Code](https://github.com/microsoft/vscode) IDE
...
- [![typescript](./src/typescript_flat_square.svg)](https://badges.aleen42.com/src/typescript_flat_square.svg) A badge used for projects that coded with [TypeScript](https://github.com/microsoft/TypeScript)
- [![cplusplus](./src/cplusplus_flat_square.svg)](https://badges.aleen42.com/src/cplusplus_flat_square.svg) A badge used for projects that coded with C++
- [![flutter](./src/flutter_flat_square.svg)](https://badges.aleen42.com/src/flutter_flat_square.svg) A badge used for projects built with [Flutter](https://github.com/flutter/flutter)
- [![python](./src/python_flat_square.svg)](https://badges.aleen42.com/src/python_flat_square.svg) A badge used for projects that coded with [Python](https://github.com/python/cpython)
...
- [![kubernetes](./src/kubernetes_flat_square.svg)](https://badges.aleen42.com/src/kubernetes_flat_square.svg) A badge used for projects using [Kubernetes](https://github.com/kubernetes/kubernetes)
- [![postgresql](./src/postgresql_flat_square.svg)](https://badges.aleen42.com/src/postgresql_flat_square.svg) A badge used for projects using [PostgreSQL](https://github.com/postgres/postgres)
...
- [![eslint](./src/eslint_flat_square.svg)](https://badges.aleen42.com/src/eslint_flat_square.svg) A badge used for projects using [ESLint](https://github.com/eslint/eslint)
...
- [![redux](./src/redux_flat_square.svg)](https://badges.aleen42.com/src/redux_flat_square.svg) A badge used for projects using [React Redux](https://github.com/reduxjs/react-redux)
...
- [![csharp](./src/csharp_flat_square.svg)](https://badges.aleen42.com/src/csharp_flat_square.svg) A badge used for projects that coded with C#
- [![jasmine](./src/jasmine_flat_square.svg)](https://badges.aleen42.com/src/jasmine_flat_square.svg) A badge used for projects using [Jasmine](https://github.com/jasmine/jasmine) for testing JavaScript
- [![qunit](./src/qunit_flat_square.svg)](https://badges.aleen42.com/src/qunit_flat_square.svg) A badge for projects using [QUnit](https://github.com/qunitjs/qunit) for unit tests
- [![reactivex](./src/reactivex_flat_square.svg)](https://badges.aleen42.com/src/reactivex_flat_square.svg) A badge for projects using [ReactiveX](https://github.com/ReactiveX/RxJS)
- [![modernizr](./src/modernizr_flat_square.svg)](https://badges.aleen42.com/src/modernizr_flat_square.svg) A badge for projects using [Modernizr](https://github.com/Modernizr/Modernizr)
...
- [![erlang](./src/erlang_flat_square.svg)](https://badges.aleen42.com/src/erlang_flat_square.svg) A badge used for projects that coded with [Erlang](https://github.com/erlang/otp)
- [![nestjs](./src/nestjs_flat_square.svg)](https://badges.aleen42.com/src/nestjs_flat_square.svg) A badge used for projects built with [NestJS](https://github.com/nestjs/nest)
...
- [![npm](./src/npm_flat_square.svg)](https://badges.aleen42.com/src/npm_flat_square.svg) A badge used for [npm](https://github.com/npm/cli) packages
